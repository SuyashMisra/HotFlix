    ...
    <div style="width: 994px;">
        <nav class="navbar navbar-light navbar-expand-md fixed-top navigation-clean-button">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navcol-1" style="max-width:256px;">
                    <span class="navbar-text actions"> 
                        <a class="btn btn-light action-button" role="button" style="padding-top: 8px;background-color: rgb(65,161,231);margin-right: 20px;" href="uploadvdo.php">Upload</a>
